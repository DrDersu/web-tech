...
<div class="container">
    ...
    <div class="container ">
        ...
        <div >
            ...
            <input type="text" class="form-control ml-2" value="" name="fedu" placeholder="Образование ...">
        ...
        <table class="table">
            ...
            <?php
            if(!isset($_POST['name'])){
            $g_row =  $pdo_conn->query("SELECT db.id,db.name1,db.lastname,db.surname,db.birthday,s.iin as siin,db.education FROM db_students db JOIN  students s on db.id = s.db_id Order by birthday DESC") ;
